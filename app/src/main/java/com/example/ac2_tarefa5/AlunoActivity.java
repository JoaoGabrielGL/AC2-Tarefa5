...
import com.example.ac2_tarefa5.api.ApiCepClient;
import com.example.ac2_tarefa5.api.ApiClient;
import com.example.ac2_tarefa5.api.AlunoService;
import com.example.ac2_tarefa5.api.CepService;
...
public class AlunoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.aluno_activity);
        ...
        if (id > 0) {
            apiAlunoService.getAlunoPorId(id).enqueue(new Callback<Aluno>() {
                @Override
    ...
    private void editarAluno(Aluno aluno) {
        Call<Aluno> call = apiAlunoService.putAluno(id, aluno);
